...
{%
	...
	\newglosentrymath{sub.z}{\mathrm{z}}{
	description={sache},
	descseclang={sache},
	parent=subscript
	}
	\newglosentrymath{sub.i}{{i}}{ % wenn kursiv gewünscht \mathrm entfernen
	description={Laufindex},
	descseclang={Lauf al Index},
	parent=subscript	
	}
}%
...
{%
	...
	parent=abbrv%
	]{ODE}{ODE}{\markup{o}rdinary \markup{d}ifferential \markup{e}quation}
	\newacronym[%
	descseclang={transformation de Laplace},%
	parent=abbrv%
	]{TL}{TL}{\markup{L}aplace \markup{t}ransform}
	\newacronym[%
	descseclang={kleine Schreibweise},%
	parent=abbrv%
	]{kS}{kS}{\markup{k}leine \markup{s}chreibweise}
}%